...
export async function logStaffActivity(userId, staffId, staffName, action) {
  ...
  if (activity) {
    return logActivity(userId, { ...activity, staffId });
  }
}

export async function logShiftActivity(userId, shiftDataOrStaffId, actionOrShiftId, actionOrDescription, description) {
