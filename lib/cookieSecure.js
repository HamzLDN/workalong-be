...
/**
 * Parent domain for session cookies so apex + {workspace}.workalong.co.uk share sessionId.
 * Override with SESSION_COOKIE_DOMAIN (e.g. .workalong.co.uk). Omit on localhost.
 */
