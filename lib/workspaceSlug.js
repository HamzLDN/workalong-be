...
/**
 * Turn a company or display name into a DNS-safe workspace label (lowercase, hyphens).
 */
...
/**
 * Pick a unique workspace slug for a user. Tries base, then base-2, base-3, … then base-{random}.
 */
