...
/**
 * Minimum Hamming gap between 1st and 2nd eligible match (multi-staff identify).
 * Too small → wrong person wins (false positive). Too large → nobody matches.
 */
...
export function findBestFaceMatchAmongStaff(faceHash, rows) {
  ...
  // Do not add a second stricter cap here: live vs enrolled on the coarse kiosk hash is often ~40–50 bits
  // for the *correct* person; capping at ~40 bits made multi-staff identify reject everyone.
